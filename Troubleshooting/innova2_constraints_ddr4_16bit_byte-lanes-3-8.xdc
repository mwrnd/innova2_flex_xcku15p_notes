...
# Byte Lane 8 - Bank 68 - For 16Bit, use as Byte Lane 1
set_property PACKAGE_PIN AN35 [get_ports {ddr4_rtl_0_dqs_t[1]}]
set_property PACKAGE_PIN AN36 [get_ports {ddr4_rtl_0_dqs_c[1]}]
set_property PACKAGE_PIN AK33 [get_ports {ddr4_rtl_0_dm_n[1]}]

set_property PACKAGE_PIN AK35 [get_ports {ddr4_rtl_0_dq[8]}]
set_property PACKAGE_PIN AM34 [get_ports {ddr4_rtl_0_dq[9]}]
set_property PACKAGE_PIN AJ34 [get_ports {ddr4_rtl_0_dq[10]}]
set_property PACKAGE_PIN AJ33 [get_ports {ddr4_rtl_0_dq[11]}]
set_property PACKAGE_PIN AM35 [get_ports {ddr4_rtl_0_dq[12]}]
set_property PACKAGE_PIN AL34 [get_ports {ddr4_rtl_0_dq[13]}]
set_property PACKAGE_PIN AL35 [get_ports {ddr4_rtl_0_dq[14]}]
set_property PACKAGE_PIN AH33 [get_ports {ddr4_rtl_0_dq[15]}]
